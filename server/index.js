...
const champsData = require('./dataJson/lolChamps.json');
const spellsData = require('./dataJson/spells.json');
const runesData = require('./dataJson/runes.json');
...
server.listen(process.env.PORT || 7779, () => {
    ...
    console.log(`Server has started with ${PORT}`)
    console.log(`RIOT_TOKEN=${process.env.RIOT_TOKEN}`)
});
